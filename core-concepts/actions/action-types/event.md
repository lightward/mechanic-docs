...
The **Event** action is for generating custom events in the [**User event domain**](../../../platform/events/topics/user.md). It's used to queue up follow-up work, either immediately or in the future, and can be useful when designing complex workloads, separating work between tasks.
