...
The **Event** action is for generating custom events in the [**User event domain**](../../events/topics/user.md). It's used to queue up follow-up work, either immediately or in the future, and can be useful when designing complex workloads, separating work between tasks.
...
| Option | Description |
| :--- | :--- |
| `topic` | Required; a string specifying an [event topic](../../events/topics/) of the form "user/\*/\*" |
