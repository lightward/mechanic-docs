...
This action is most useful in concert with [mechanic/actions/perform](../../../platform/events/topics/mechanic.md#actions), by which a task may take the resulting file URLs and pass them on to another service. Used by itself, this action can also be useful for quickly testing file generators.
