...
1. An event is created – possibly by a [Shopify webhook](), or by a [user webhook](../../platform/webhooks.md), by the [Mechanic scheduler](), or by an [Event action](../actions/action-types/event.md).
