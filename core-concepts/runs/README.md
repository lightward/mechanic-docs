...
* **Action runs**, when performed, have results that vary by [action type](../actions/types/).
...
1. An event is created – possibly by a [Shopify webhook](), or by a [user webhook](../../platform/webhooks.md), by the [Mechanic scheduler](), or by an [Event action](../actions/types/event.md).
