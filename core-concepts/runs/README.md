...
1. An event is created – possibly by a [Shopify webhook](../events/event-topic-reference/shopify.md), or by a [user webhook](../../platform/webhooks.md), by the [Mechanic scheduler](../events/event-topic-reference/mechanic.md#scheduler), or by an [Event action](../actions/action-types/event.md).
