...
* The [Shopify](core/actions/shopify.md) action makes changes to a Shopify store, like tagging, publishing, creating or deleting resources. It provides direct access to Shopify's Admin API. Use GraphQL for new Shopify automation work.
