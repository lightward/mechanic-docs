...
* [Reading and Writing to Shopify](core/shopify/README.md)
  ...
  * [Reading data](core/shopify/read/README.md)
    * [⚠️ Liquid objects](core/shopify/read/liquid-objects.md)
...
* [Globals and secrets](platform/globals-and-secrets.md)
...
* [Liquid](platform/liquid/README.md)
  ...
  * [Mechanic objects](platform/liquid/objects/README.md)
    ...
    * [Globals object](platform/liquid/objects/globals.md)
    * [Options object](platform/liquid/objects/options.md)
    * [Secrets object](platform/liquid/objects/secrets.md)
    * [Task object](platform/liquid/objects/task.md)
    * [⚠️ Shopify REST Admin API](platform/liquid/objects/shopify/README.md)
...
* [Forms](app/forms.md)
  * [Thank you and Order status forms](app/thank-you-and-order-status-forms.md)
    * [Respond to an order request](app/respond-to-an-order-request.md)
...
* [FAQ](faq/README.md)
  ...
  * [Can Mechanic events or tasks be prioritized?](faq/can-mechanic-events-or-tasks-be-prioritized.md)
