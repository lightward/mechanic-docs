...
* [Actions](core/actions/README.md)
  * [Action types](core/actions/types/README.md)
    * [Cache](core/actions/types/cache.md)
    * [Echo](core/actions/types/echo.md)
    * [Email](core/actions/types/email.md)
    * [Event](core/actions/types/event.md)
    * [Files](core/actions/types/files.md)
    * [FTP](core/actions/types/ftp.md)
    * [HTTP](core/actions/types/http.md)
    * [Shopify](core/actions/types/shopify.md)
...
* [Interacting with Shopify](core/interacting-with-shopify/README.md)
  * [API versions](core/interacting-with-shopify/api-versions.md)
