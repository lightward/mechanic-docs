...
When using the `{% ... %}` syntax, the Liquid code inside is given the opportunity to perform work without generating output. This syntax is for preparing and modifying [variables](variables.md) (using tags like [assign](../tags/assign.md)), or for specifying [control flow](control-flow/) (using [conditions](control-flow/condition.md) or [iteration](control-flow/iteration.md)).
