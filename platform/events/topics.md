...
{% hint style="warning" %}
Note that this list does not contain Shopify's event topics for customer subscriptions. As of this writing, Shopify only allows apps to access subscriptions that they create. As such, Mechanic cannot offer customer subscription events.
{% endhint %}

{% hint style="info" %}
For a description of each topic's behavior, see [Shopify's webhook event topic documentation](https://shopify.dev/api/admin-rest/latest/resources/webhook#event-topics).
{% endhint %}
...
* shopify/collection\_listings/add
* shopify/collection\_listings/remove
* shopify/collection\_listings/update
* shopify/collection\_publications/create
* shopify/collection\_publications/delete
* shopify/collection\_publications/update
...
* shopify/product\_listings/add
* shopify/product\_listings/remove
* shopify/product\_listings/update
* shopify/product\_publications/create
* shopify/product\_publications/delete
* shopify/product\_publications/update
...
* shopify/scheduled\_product\_listings/add
* shopify/scheduled\_product\_listings/remove
* shopify/scheduled\_product\_listings/update
* shopify/segments/create
* shopify/segments/delete
* shopify/segments/update
* shopify/selling\_plan\_groups/create
* shopify/selling\_plan\_groups/delete
* shopify/selling\_plan\_groups/update
* shopify/shop/update
