...
{% hint style="info" %}
The console can make Shopify Admin API requests (up to 10 per submission), which [task previews](../core/tasks/previews/) cannot. However, it has tighter memory limits than actual task runs. If you hit a limit, try testing your code in a task subscribing to mechanic/user/trigger instead.
{% endhint %}
