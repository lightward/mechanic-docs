...
Using the reference information available in these docs, write your own Mechanic task code to iterate over the rows of data (array of hashes) that is parsed from the CSV, and make useful [updates to your Shopify data](../../core/actions/shopify.md) using the GraphQL or REST APIs.
