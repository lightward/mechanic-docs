---
description: Translate Mechanic task content by using separate task copies per locale or custom task options for locale-specific content.
---
...
In other cases, task code can be customized to allow for specifying multiple translations within a single task, switching between them as appropriate. (Typically, this means adding a [keyval option](../core/tasks/options/#3-flags) allowing the user to specify and identify content as needed.)
