...
| `secrets` | The current store's write-only [secrets](../../../platform/liquid/objects/secrets.md), returned as opaque references unless used by a supported action or signing filter |
