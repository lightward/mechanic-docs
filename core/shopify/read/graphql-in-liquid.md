...
Note that this Liquid filter does not support running mutations \(i.e. writing Shopify data via GraphQL\). To run mutations, use the [Shopify](../../actions/shopify.md) action.
